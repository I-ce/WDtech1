...
public class RegexUtils {
	 ...
	 */
	public static final String PHONE_NUMBER_REGEX = "^1{1}(3{1}\\d{1}|5{1}[012356789]{1}|8{1}[035689]{1}|7{1}[035678]{1}|4{1}[5,6,7,9]{1}|9{1}[8,9]|(66))\\d{8}$";
													  //  "^((13[0-9])|(15[^4])|(18[0,2-9])|(17[0-8])|(14[5,6,7,9])|(19[8,9])|(166))\\\\d{8}$"
	/**
	 * 匹配邮箱的正则表达式
	 * <br>"www."可省略不写
	 */
	 ...
	 * 如果符合正确条件返回false
	 */
	public static boolean checkPwdLength(String pro) {
        if (pro.length() < 6 || pro.length() > 16) {
			return true;
		}
		return false;
	}
