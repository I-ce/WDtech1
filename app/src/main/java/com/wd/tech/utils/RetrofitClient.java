...
import com.wd.tech.service.Service;
...
public class RetrofitClient {
    ...
    public Service getCommonApi() throws KeyManagementException, NoSuchAlgorithmException {
        return mCommentsApi == null ? configRetrofit(Service.class) : mCommentsApi;
    }
    ...
    private <T> T configRetrofit(Class<T> service) throws NoSuchAlgorithmException, KeyManagementException{
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(new MyLogging()).build();
        //Retrofit
